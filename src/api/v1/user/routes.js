...
routes
  .route("/refresh-token")
  .put(validate(refreshToken), authorize(), controller.refreshToken);
...
routes
  .route("/add-people")
  .post(validate(addPeople), authorize(), controller.addPeople);
...
routes
  ...
  .get(validate(userAvailable), authorize(), controller.userAvailable);
...
routes
  ...
  .put(validate(blockUnblock), authorize(), controller.blockUnblock);
...
routes
  ...
  .put(validate(changeRole), authorize(), controller.changeRole);
